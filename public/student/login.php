                ...
                <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 lg:grid-cols-3 mt-4">
                    ...
                    <div class="lg:col-span-2 text-black font-normal dark:text-white">
                        ...
                        <div class="md:col-span-5 flex  justify-center">
                            <span class=" mt-3 rounded w-full text-black text-lg font-regular dark:text-white"> Don't Have an Account?  
                                <a href="signup.php" class="text-[#009579] hover:underline decoration-[#009579] dark:text-[#009579]"> Sign up</a>
                            </span>
                        </div>
                    </div>
                </div>
