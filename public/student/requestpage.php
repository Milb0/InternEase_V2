                        ...
                        <form method="POST" action="requestpage.php">
                            <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
                                <div class="<?php echo (!empty($theme_err)) ? 'md:col-span-5 text-red-500' : 'md:col-span-5'; ?>">
                                    ...
                                    <input type="text" name="theme" id="theme" class="h-10 border mt-1 rounded px-4 w-full bg-gray-50 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white<?php echo (!empty($theme_err)) ? 'border-red-500' : ''; ?>" placeholder="Your Internship Theme" value="<?php echo $theme; ?>" required />
                                    <span><?php echo $theme_err; ?></span>
                                </div>

                                <div class="<?php echo (!empty($description_err)) ? 'md:col-span-5 text-red-500' : 'md:col-span-5'; ?>">
                                    <label for="description">Description</label>
                                    <textarea rows="4" name="description" id="description" class="border mt-1 rounded px-4 w-full bg-gray-50 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white<?php echo (!empty($description_err)) ? 'border-red-500' : ''; ?>" placeholder="Enter your internship description here..." required><?php echo $description; ?></textarea>
                                ...
                                <div class="md:col-span-2 <?php echo (!empty($startDate_err)) ? 'text-red-500' : ''; ?>">
                                    ...
                                    <input type="date" name="start_date" id="start_date" class="h-10 border mt-1 rounded px-4 w-full bg-gray-50 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white<?php echo (!empty($startDate_err)) ? 'border-red-500' : ''; ?>" placeholder="" value="<?php echo $startDate; ?>" required />
                                    <span><?php echo $startDate_err; ?></span>
                                </div>

                                <div class="md:col-span-2 <?php echo (!empty($endDate_err)) ? 'text-red-500' : ''; ?>">
                                    <label for="end_date">End Date</label>
                                    <input type="date" name="end_date" id="end_date" class="h-10 border mt-1 rounded px-4 w-full bg-gray-50 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white<?php echo (!empty($endDate_err)) ? 'border-red-500' : ''; ?>" placeholder="" value="<?php echo $endDate; ?>" required />
                                ...
                                <div class="md:col-span-1 <?php echo (!empty($period_err)) ? 'text-red-500' : ''; ?>">
                                    ...
                                    <input type="number" name="period" id="period" class="h-10 border mt-1 rounded px-4 w-full bg-gray-50 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white<?php echo (!empty($period_err)) ? 'border-red-500' : ''; ?>" placeholder="" value="<?php echo $period; ?>" required />
                                ...
                                <div class="<?php echo (!empty($fullName_err)) ? 'md:col-span-5 text-red-500' : 'md:col-span-5'; ?>">
                                    ...
                                    <input type="text" name="full_name" id="full_name" class="h-10 border mt-1 rounded px-4 w-full bg-gray-50 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white<?php echo (!empty($fullName_err)) ? 'border-red-500' : ''; ?>" placeholder="Your supervisor full name" value="<?php echo $fullName; ?>" required />
                                    <span><?php echo $fullName_err; ?></span>
                                </div>

                                <div class="md:col-span-5 <?php echo (!empty($email_err)) ? 'text-red-500' : ''; ?>">
                                    <label for="email">Email</label>
                                    <input type="email" name="email" id="email" class="h-10 border mt-1 rounded px-4 w-full bg-gray-50 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white<?php echo (!empty($email_err)) ? 'border-red-500' : ''; ?>" placeholder="email@domain.com" value="<?php echo $email; ?>" required />
                                    <span><?php echo $email_err; ?></span>
                                </div>

                                <div class="md:col-span-5 <?php echo (!empty($confirmEmail_err)) ? 'text-red-500' : ''; ?>">
                                    <label for="confirm_email">Confirm Email</label>
                                    <input type="text" name="confirm_email" id="confirm_email" class="h-10 border mt-1 rounded px-4 w-full bg-gray-50 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white<?php echo (!empty($confirmEmail_err)) ? 'border-red-500' : ''; ?>" placeholder="Confirm your supervisor's email" value="<?php echo $confirmEmail; ?>" required />
                                    <span><?php echo $confirmEmail_err; ?></span>
                                </div>
                                <div class="md:col-span-2 <?php echo (!empty($phoneNumber_err)) ? 'text-red-500' : ''; ?>">
                                    <label for="phonenumber">Phone Number</label>
                                    <input type="tel" name="phonenumber" id="phonenumber" class="h-10 border mt-1 rounded px-4 w-full bg-gray-50 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white<?php echo (!empty($phoneNumber_err)) ? 'border-red-500' : ''; ?>" value="" placeholder="Your supervisor's phone number" value="<?php echo $phoneNumber; ?>" required />
                                    <span><?php echo $phoneNumber_err; ?></span>
                                </div>
                                <div class="md:col-span-2 <?php echo (!empty($faxNumber_err)) ? 'text-red-500' : ''; ?>">
                                    <label for="fax">Fax Number</label>
                                    <input type="tel" name="fax" id="fax" class="h-10 border mt-1 rounded px-4 w-full bg-gray-50 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white<?php echo (!empty($faxNumber_err)) ? 'border-red-500' : ''; ?>" placeholder="Your supervisor's work fax number" value="<?php echo $faxNumber; ?>" required />
                                ...
                                <div class="md:col-span-2 <?php echo (!empty($company_err)) ? 'text-red-500' : ''; ?>">
                                    ...
                                    <input type="text" name="company_name" id="company_name" class="h-10 border mt-1 rounded px-4 w-full bg-gray-50 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white<?php echo (!empty($company_err)) ? 'border-red-500' : ''; ?>" placeholder="ex: Algerie poste" value="<?php echo $companyName; ?>" required />
                                    <span><?php echo $company_err; ?></span>
                                </div>
                                <div class="md:col-span-3 <?php echo (!empty($company_address_err)) ? 'text-red-500' : ''; ?>">
                                    <label for="company_address">Company Address</label>
                                    <input type="text" name="company_address" id="company_address" class="h-10 border mt-1 rounded px-4 w-full bg-gray-50 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white<?php echo (!empty($company_address_err)) ? 'border-red-500' : ''; ?>" placeholder="ex: UV N°1 Ilot 01 Cité Nouvelle Ville..." value="<?php echo $companyAddress; ?>" required />
