...
$information= $supervisor->getInternshipSupervisor($_SESSION['id'], false);
                ...
                <div class="relative ml-3">
                    <div>
                        <button type="button" class="flex text-sm rounded-full focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" aria-expanded="false" data-dropdown-toggle="dropdown-user" onclick="toggleMenu()">
                            ...
                            <img class="w-9 h-9 rounded-full overflow-hidden" src="../assets/images/supervisor_avatar.png" alt="user photo">
                        </button>
                    </div>
...
<aside id="sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700" aria-label="Sidebar">
    <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
        <ul class="space-y-2 font-medium">
            ...
            <li>
                <a href="completedrequests.php" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                    <i class="fa-solid fa-list"></i>
                    <span class="flex-1 ml-3 whitespace-nowrap">Completed Requests</span>
                </a>
            </li>
            <li>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md">
            <div class="px-6 py-4">
                ...
                <div class="mt-4">
                    ...
                    <p class="text-sm text-gray-500 dark:text-gray-400 dark:text-white"><strong>Fax Number:</strong> <?php echo $information["phonenumber"]; ?></p>
                </div>
            </div>
        </div>
        <br />
