...
$headOfDepartment = new  DepartmentHead($db_conn);
$information= $headOfDepartment->getDepartmentHead($_SESSION['id']);
require_once BASE_DIR . 'app/includes/header.php';
?>
...
<aside id="sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700" aria-label="Sidebar">
    <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
        <ul class="space-y-2 font-medium">
            ...
            <li>
                <a href="requesthistory.php" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                    <i class="fa-solid fa-list"></i>
                    <span class="flex-1 ml-3 whitespace-nowrap">Requests History</span>
                </a>
            </li>
            <li>
            ...
            <li>
                <a href="internshipsupervisors.php" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                    <i class="fa-solid fa-envelope-open-text"></i>
                    <span class="flex-1 ml-3 whitespace-nowrap">Internship Supervisors</span>
                </a>
            </li>
            <li>
